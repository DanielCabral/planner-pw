       ...
       <div className='w-full h-screen'>        
          <div className='pt-4 px-2 lg:pt-10 lg:px-56'>
            ...
            <div className='flex flex-col lg:flex-row justify-between items-center'>
                ...
                <div>
                    <Link to='edit-planner' className='cursor-pointer'>
                            <div className="transform hover:scale-105 transition duration-300 w-56 h-56 p-8 border border-secondary rounded-full ">
            ...
            <Link to='edit-planner' className='cursor-pointer'>
                <div className='flex flex-col items-center'>
                    ...
                    <FiChevronDown className='mt-2 animate-bounce text-4xl text-secondary text-center' />
                </div>
            </Link>
          </div>
       </div>
