    ...
    return (
       <div className='w-full h-screen'>        
          <div className='pt-2 lg:pt-20 px-2 lg:px-20'>
              ...
              <div className={`w-28 h-32 lg:w-32 lg:h-40 bg-fourth rounded-xl `}>
                                ...
                                <div className="h-2 lg:h-8 mb-4 w-full flex justify-between items-center">
                                    <p className="ml-1 text-white font-light text-xs">Titulo</p>
                                    <a href='/planners'className='cursor-pointer'><FiMoreVertical className='text-white text-lg' /></a>
                                </div>
                            </div>
                            <div className={`w-28 h-32 lg:w-32 lg:h-40 bg-danger rounded-xl `}>
                                <div className='h-28 lg:h-32 flex justify-center items-center'>
                            ...
                            <div className={`w-28 h-32 lg:w-32 lg:h-40 bg-alert rounded-xl `}>
                                <div className='h-28 lg:h-32 flex justify-center items-center'>
                            ...
                            <div className={`w-28 h-32 lg:w-32 lg:h-40 bg-link rounded-xl `}>
                                <div className='h-28 lg:h-32 flex justify-center items-center'>
